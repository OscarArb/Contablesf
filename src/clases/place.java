 ...
 * class construction.
 */
public class place extends JLabel implements FocusListener, DocumentListener {
	/**
	 * 
	 */
	...
	public place(String text, JTextComponent component) {
		this(text, component, Show.ALWAYS);
	}

	public place(String text, JTextComponent component, Show show) {
